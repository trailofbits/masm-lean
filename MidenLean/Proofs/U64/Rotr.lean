...
theorem u64_rotr_correct
  ...
  miden_swap
  -- 11: u32WrappingSub
  have h32_u32 : (32 : Felt).isU32 = true := by native_decide
  have h_and_u32 : (Felt.ofNat (shift.val &&& (31 : Felt).val)).isU32 = true := by
    ...
    rw [felt_ofNat_val_lt _ (by
      ...
      unfold GOLDILOCKS_PRIME; omega)]
    have : shift.val &&& 31 ≤ 31 := Nat.and_le_right; omega
  rw [stepU32WrappingSub (ha := h32_u32) (hb := h_and_u32)]; miden_bind
  -- 12: pow2
