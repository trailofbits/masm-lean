...
/-- `u64::and` computes bitwise AND of two u64 values, limb by limb.
    ...
    summary for reflective callers and as the basis for `u64_and_correct`. -/
@[miden_exec_summary]
theorem u64_and_exec
    ...
    execProcedure env (fuel + 1) s Miden.Core.U64.and =
    some (s.withStack (
...
theorem u64_and_correct (a b : U64) (rest : List Felt) (s : Concrete.State)
  ...
  exact u64_and_exec emptyEnv 9 a.lo.val a.hi.val b.lo.val b.hi.val rest s hs a.lo.isU32 a.hi.isU32 b.lo.isU32 b.hi.isU32
