...
/-- `u64::or` computes bitwise OR of two u64 values, limb by limb.
    ...
    summary for reflective callers and as the basis for `u64_or_correct`. -/
@[miden_exec_summary]
theorem u64_or_exec
    ...
    execProcedure env (fuel + 1) s Miden.Core.U64.or =
    some (s.withStack (
...
theorem u64_or_correct (a b : U64) (rest : List Felt) (s : Concrete.State)
    (hs : s.stack = b.lo.val :: b.hi.val :: a.lo.val :: a.hi.val :: rest) :
    execProcedure emptyEnv 10 s Miden.Core.U64.or =
  ...
  exact u64_or_exec emptyEnv 9 a.lo.val a.hi.val b.lo.val b.hi.val rest s hs a.lo.isU32 a.hi.isU32 b.lo.isU32 b.hi.isU32
