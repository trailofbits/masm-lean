...
/-- Raw version of `u64::wrapping_mul` with explicit Felt arguments.
    ...
    summary for reflective callers and as the basis for `u64_wrapping_mul_correct`. -/
@[miden_exec_summary]
theorem u64_wrapping_mul_exec
    ...
    execProcedure env (fuel + 1) s Miden.Core.U64.wrapping_mul =
    some (s.withStack (
...
theorem u64_wrapping_mul_correct (a b : U64) (rest : List Felt) (s : Concrete.State)
  ...
  rw [u64_wrapping_mul_exec emptyEnv 19 a.lo.val a.hi.val b.lo.val b.hi.val rest s hs a.lo.isU32 a.hi.isU32 b.lo.isU32 b.hi.isU32]
