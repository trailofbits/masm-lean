...
/-- `u128::or` computes bitwise OR of two 128-bit values, limb by limb.
    Input stack:  [b0, b1, b2, b3, a0, a1, a2, a3] ++ rest
    Output stack: [b0 ||| a0, a1 ||| b1, a2 ||| b2, a3 ||| b3] ++ rest
    Parametric in `env` and `fuel` so this lemma serves both as a callee
    summary for reflective callers and as the basis for `u128_or_correct`. -/
@[miden_exec_summary]
theorem u128_or_exec
    ...
    execProcedure env (fuel + 1) s Miden.Core.U128.or =
    some (s.withStack (
...
theorem u128_or_correct (a b : U128) (rest : List Felt) (s : Concrete.State)
  ...
  simp only [U128.or_a0, U128.or_a1, U128.or_a2, U128.or_a3,
    Nat.or_comm a.a0.val.val]
  exact u128_or_exec emptyEnv 16 a.a0.val a.a1.val a.a2.val a.a3.val
