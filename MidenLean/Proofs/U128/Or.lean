...
theorem u128_or_raw
  ...
  subst hs
  unfold Miden.Core.U128.or execProcedure
  ...
  miden_movup
  miden_movup
  rw [stepU32Or (ha := ha1) (hb := hb1)]
  miden_bind
  miden_movup
  miden_movup
  rw [stepU32Or (ha := ha2) (hb := hb2)]
  miden_bind
  miden_movup
  miden_movup
  rw [stepU32Or (ha := ha3) (hb := hb3)]
  miden_bind
  rw [stepReversew]
...
theorem u128_or_correct (a b : U128) (rest : List Felt) (s : Concrete.State)
  ...
  simp only [U128.or_a0, U128.or_a1, U128.or_a2, U128.or_a3,
    Nat.or_comm a.a0.val.val, Nat.or_comm a.a1.val.val,
    Nat.or_comm a.a2.val.val, Nat.or_comm a.a3.val.val]
  exact u128_or_raw a.a0.val a.a1.val a.a2.val a.a3.val
