...
/-- `u128::lte` compares two u128 values (raw limb version).
    ...
    reflective callers and as the basis for `u128_lte_correct`. -/
@[miden_exec_summary]
theorem u128_lte_exec
    (fuel : Nat)
    ...
    execProcedure u128ProcEnv (fuel + 3) s Miden.Core.U128.lte =
...
theorem u128_lte_correct (a b : U128) (rest : List Felt) (s : Concrete.State)
  ...
  rw [u128_lte_exec 28 a.a0.val a.a1.val a.a2.val a.a3.val b.a0.val b.a1.val b.a2.val b.a3.val rest s hs
