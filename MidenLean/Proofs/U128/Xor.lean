...
/-- `u128::xor` computes bitwise XOR of two 128-bit values, limb by limb.
    Input stack:  [b0, b1, b2, b3, a0, a1, a2, a3] ++ rest
    Output stack: [b0 ^^^ a0, a1 ^^^ b1, a2 ^^^ b2, a3 ^^^ b3] ++ rest
    Parametric in `env` and `fuel` so this lemma serves both as a callee
    summary for reflective callers and as the basis for `u128_xor_correct`. -/
@[miden_exec_summary]
theorem u128_xor_exec
    ...
    execProcedure env (fuel + 1) s Miden.Core.U128.xor =
    some (s.withStack (
...
theorem u128_xor_correct (a b : U128) (rest : List Felt) (s : Concrete.State)
    (hs : s.stack = b.a0.val :: b.a1.val :: b.a2.val :: b.a3.val ::
                    a.a0.val :: a.a1.val :: a.a2.val :: a.a3.val :: rest) :
    execProcedure emptyEnv 17 s Miden.Core.U128.xor =
    some (s.withStack (
      (a ^^^ b).a0.val :: (a ^^^ b).a1.val ::
      (a ^^^ b).a2.val :: (a ^^^ b).a3.val :: rest)) := by
  simp only [U128.xor_a0, U128.xor_a1, U128.xor_a2, U128.xor_a3,
    Nat.xor_comm a.a0.val.val]
  exact u128_xor_exec emptyEnv 16 a.a0.val a.a1.val a.a2.val a.a3.val
