...
theorem u128_gte_run
  ...
  unfold Miden.Core.U128.gte execProcedure
  simp only [List.foldlM, u128ProcEnv]
  dsimp only [bind, Bind.bind, Option.bind]
  rw [u128_lt_run fuel a0 a1 a2 a3 b0 b1 b2 b3 rest mem frames adv
...
theorem u128_gte_raw
  ...
  subst hs
  simpa using u128_gte_run 28 a0 a1 a2 a3 b0 b1 b2 b3 rest mem frames adv
    ha0 ha1 ha2 ha3 hb0 hb1 hb2 hb3
