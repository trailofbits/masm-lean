...
theorem u128_max_correct (a b : U128) (rest : List Felt) (s : MidenState)
    ...
    execWithEnv u128ProcEnv 37 s Miden.Core.U128.max =
    some (s.withStack (
      (if decide (a < b) then b.a0.val else a.a0.val) ::
      (if decide (a < b) then b.a1.val else a.a1.val) ::
      (if decide (a < b) then b.a2.val else a.a2.val) ::
      (if decide (a < b) then b.a3.val else a.a3.val) :: rest)) := by
