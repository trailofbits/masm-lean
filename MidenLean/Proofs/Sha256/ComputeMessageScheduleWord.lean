...
private theorem compute_msw_reject_empty
    ...
    execWithEnv sha256ProcEnv 20 ⟨[], mem, frames, adv⟩
  ...
  have h_s1_rej : execWithEnv sha256ProcEnv 19 ⟨[], mem, frames, adv⟩
...
private theorem compute_msw_reject_one
    (w2 : Felt) (mem : Nat → Felt) (frames : List LocalFrame) (adv : List Felt) :
    execWithEnv sha256ProcEnv 20 ⟨[w2], mem, frames, adv⟩
      Miden.Crypto.Sha256.compute_message_schedule_word = none := by
  unfold Miden.Crypto.Sha256.compute_message_schedule_word execWithEnv
  simp only [List.foldlM, sha256ProcEnv]
  by_cases hw2 : w2.isU32 = true
  · rw [sigma1_fuel_19_eq_20]
    rw [sha256_small_sigma_1_correct w2 [] ⟨[w2], mem, frames, adv⟩ rfl hw2]
    simp [bind_some_eq, MidenState.withStack, execInstruction, execMovup, removeNth]
  · have h_s1_rej : execWithEnv sha256ProcEnv 19 ⟨[w2], mem, frames, adv⟩
        Miden.Crypto.Sha256.small_sigma_1 = none := by
      rw [sigma1_fuel_19_eq_20]
...
private theorem compute_msw_reject_two
    (w2 w7 : Felt) (mem : Nat → Felt) (frames : List LocalFrame) (adv : List Felt) :
    execWithEnv sha256ProcEnv 20 ⟨[w2, w7], mem, frames, adv⟩
      Miden.Crypto.Sha256.compute_message_schedule_word = none := by
  unfold Miden.Crypto.Sha256.compute_message_schedule_word execWithEnv
  simp only [List.foldlM, sha256ProcEnv]
  by_cases hw2 : w2.isU32 = true
  · rw [sigma1_fuel_19_eq_20]
    rw [sha256_small_sigma_1_correct w2 [w7] ⟨[w2, w7], mem, frames, adv⟩ rfl hw2]
    simp [bind_some_eq, MidenState.withStack, execInstruction, execMovup, removeNth]
  · have h_s1_rej : execWithEnv sha256ProcEnv 19 ⟨[w2, w7], mem, frames, adv⟩
        Miden.Crypto.Sha256.small_sigma_1 = none := by
      rw [sigma1_fuel_19_eq_20]
      apply sha256_small_sigma_1_rejects_invalid_input
      rintro ⟨x, rest', hstk, hx_u32⟩
...
private theorem compute_msw_reject_three
    (w2 w7 w15 : Felt) (mem : Nat → Felt) (frames : List LocalFrame) (adv : List Felt) :
    execWithEnv sha256ProcEnv 20 ⟨[w2, w7, w15], mem, frames, adv⟩
      Miden.Crypto.Sha256.compute_message_schedule_word = none := by
  unfold Miden.Crypto.Sha256.compute_message_schedule_word execWithEnv
  simp only [List.foldlM, sha256ProcEnv]
  by_cases hw2 : w2.isU32 = true
  · rw [sigma1_fuel_19_eq_20]
    rw [sha256_small_sigma_1_correct w2 [w7, w15] ⟨[w2, w7, w15], mem, frames, adv⟩ rfl hw2]
    ...
    · rw [sigma0_fuel_19_eq_20]
      rw [sha256_small_sigma_0_correct w15
        ...
        ⟨[w15, Felt.ofNat (Sha256Spec.smallSigma1 (BitVec.ofNat 32 w2.val)).toNat, w7], mem, frames, adv⟩
        rfl hw15]
  ...
  · have h_s1_rej : execWithEnv sha256ProcEnv 19 ⟨[w2, w7, w15], mem, frames, adv⟩
        Miden.Crypto.Sha256.small_sigma_1 = none := by
      rw [sigma1_fuel_19_eq_20]
      apply sha256_small_sigma_1_rejects_invalid_input
      rintro ⟨x, rest', hstk, hx_u32⟩
...
theorem compute_msw_layer1_executes_local
  ...
  rw [sha256_small_sigma_1_layer1_executes_local w2 (w7 :: w15 :: w16 :: rest)
    ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩ rfl h2]
  ...
  rw [sha256_small_sigma_0_layer1_executes_local w15
    ...
    ⟨w15 :: sha256_small_sigma_1_local_out w2 :: w7 :: w16 :: rest, mem, frames, adv⟩ rfl h15]
...
theorem compute_msw_layer1_reject
  ...
  · -- sigma_1 succeeds (w2 is u32)
    ...
    rw [sha256_small_sigma_1_correct w2 (w7 :: w15 :: w16 :: rest)
      ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩ rfl hw2_u32]
    ...
    · -- sigma_0 succeeds (w15 is u32). w7 or w16 must be bad.
      ...
      rw [sha256_small_sigma_0_correct w15
        ...
        ⟨w15 :: Felt.ofNat (Sha256Spec.smallSigma1 (BitVec.ofNat 32 w2.val)).toNat
          :: w7 :: w16 :: rest, mem, frames, adv⟩ rfl hw15_u32]
      simp only [bind_some_eq, MidenState.withStack]
  ...
  · -- sigma_1 rejects (w2 is not u32)
    have h_s1_rej : execWithEnv sha256ProcEnv 20
        ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩
        Miden.Crypto.Sha256.small_sigma_1 = none := by
      apply sha256_small_sigma_1_rejects_invalid_input
      rintro ⟨x, rest', hstk, hx_u32⟩
...
theorem compute_msw_layer1_total
  ...
  · intro h_exec
    ...
    | [] =>
      exfalso
      rw [compute_msw_reject_empty mem frames adv] at h_exec
      cases h_exec
    | [w2] =>
      exfalso
      rw [compute_msw_reject_one w2 mem frames adv] at h_exec
      cases h_exec
    | [w2, w7] =>
      exfalso
      rw [compute_msw_reject_two w2 w7 mem frames adv] at h_exec
      cases h_exec
    | [w2, w7, w15] =>
      exfalso
      rw [compute_msw_reject_three w2 w7 w15 mem frames adv] at h_exec
      cases h_exec
    | w2 :: w7 :: w15 :: w16 :: rest =>
        ...
        · by_cases h15 : w15.isU32 = true
          · by_cases h16 : w16.isU32 = true
            · refine ⟨⟨w2, w7, w15, w16, rest, rfl, ?_⟩,
                (compute_msw_dom_iff ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩).2
                  ⟨w2, w7, w15, w16, rest, rfl, h2, h7, h15, h16⟩⟩
              have h_local := compute_msw_layer1_executes_local w2 w7 w15 w16 rest
                ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩ rfl h2 h7 h15 h16
            ...
            · have h16_false : w16.isU32 = false := by
              ...
              have h_none := compute_msw_layer1_reject w2 w7 w15 w16 rest
                ⟨w2 :: w7 :: w15 :: w16 :: rest, mem, frames, adv⟩ rfl
