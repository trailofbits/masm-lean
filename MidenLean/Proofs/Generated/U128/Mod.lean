...
-- Classification: SEMI | Style: FLAT_EXPLICIT | Instructions: 3 | Inputs: 8 | Calls: true | Branches: false | Loops: false | Advice: false
set_option maxHeartbeats 4000000 in
-- TODO: replace the theorem doc comment below with a high-level correctness description for README table generation.
/-- u128.mod: (auto-generated skeleton)
...
theorem u128_mod_correct
    ...
    := by
  miden_setup_env Miden.Core.U128.mod
  -- Instruction 1: execProcedure emptyEnv "divmod"
  try (simp only [u128ProcEnv])
  try (miden_call Miden.Core.U128.divmod)
