...
theorem stepAssertWithError_none (msg : String) (mem locs : Nat → Felt) (adv : List Felt)
    (a : Felt) (rest : List Felt) (h : a.val ≠ 1) :
...
theorem stepAssertEqWithError_none (msg : String) (mem locs : Nat → Felt) (adv : List Felt)
