...
theorem stepAndIte (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    execInstruction
      ...
      Instruction.and =
    some ⟨(if q && p then (1 : Felt) else 0) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepNotIte (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    execInstruction
      ...
      Instruction.not =
    some ⟨(if !p then (1 : Felt) else 0) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32WidenAdd (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat ((a.val + b.val) % 2^32) ::
          Felt.ofNat ((a.val + b.val) / 2^32) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32WidenAdd3 (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat ((a.val + b.val + c.val) % 2^32) ::
          Felt.ofNat ((a.val + b.val + c.val) / 2^32) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32And (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (a.val &&& b.val) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32Clz (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (u32CountLeadingZeros a.val) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32Ctz (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (u32CountTrailingZeros a.val) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32Clo (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (u32CountLeadingZeros (a.val ^^^ (u32Max - 1))) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32Cto (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (u32CountTrailingZeros (a.val ^^^ (u32Max - 1))) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32WrappingSub (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (u32OverflowingSub a.val b.val).2 :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepU32DivMod (mem locs : Nat → Word) (adv : List Felt) (evts : List Felt)
    ...
    some ⟨Felt.ofNat (a.val % b.val) :: Felt.ofNat (a.val / b.val) :: rest, mem, locs, adv, evts⟩ := by
...
theorem stepEmitImm (v : Felt) (s : MidenState) :
