...
| Procedure | Theorem | Summary | Manual proof file |
| --- | --- | --- | --- |
| `u256::add_with_carry_be` | `u256_add_with_carry_be_correct` | `u256::add_with_carry_be` adds two big-endian 256-bit values with carry propagation. | `MidenLean/Proofs/U256/AddWithCarryBe.lean` |
