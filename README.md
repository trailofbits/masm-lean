...
| `u128::shr_k1`          | `u128_shr_k1_correct`          | `u128::shr_k1` correctly returns the low three limbs of a u128 value shifted right by `32 + shift` bits. | `MidenLean/Proofs/U128/ShrK1.lean`          |
| `u128::shr_k2`          | `u128_shr_k2_correct`          | `u128::shr_k2` correctly returns the low two limbs of a u128 value shifted right by `64 + shift` bits.   | `MidenLean/Proofs/U128/ShrK2.lean`          |
| `u128::shr_k3`          | `u128_shr_k3_correct`          | `u128::shr_k3` correctly returns the low limb of a u128 value shifted right by `96 + shift` bits.        | `MidenLean/Proofs/U128/ShrK3.lean`          |
